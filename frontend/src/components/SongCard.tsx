        ...
        <div className="w-full aspect-square rounded-lg bg-theme-elevated mb-3 overflow-hidden relative shadow-md flex items-center justify-center">
          ...
          <div className="absolute top-2 right-2 z-10" ref={menuRef}>
            <button
              ...
              className="w-7 h-7 rounded-full bg-black/60 backdrop-blur-md text-white/90 hover:text-white flex items-center justify-center opacity-80 sm:opacity-0 group-hover:opacity-100 transition-opacity"
